                  ...
                  >
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <div className="relative">
                          <select
                            ...
                            onChange={handleChange}
                            className="w-full pl-3 pr-8 py-2 bg-[#1B1B1B]/40 border border-[#FFE7D0]/10 rounded-lg text-xs text-[#FFE7D0] focus:outline-none focus:border-[#FC6E20]/50 transition-colors font-sans appearance-none"
                          >
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-3 py-2 bg-[#1B1B1B]/40 border border-[#FFE7D0]/10 rounded-lg text-xs text-[#FFE7D0] focus:outline-none focus:border-[#FC6E20]/50 transition-colors font-sans appearance-none pr-8"
                      >
