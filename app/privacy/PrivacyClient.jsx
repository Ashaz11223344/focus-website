      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-24 relative z-10">
        ...
        <div className="space-y-10 text-sm md:text-base text-[#FFE7D0]/80 leading-relaxed font-sans prose prose-invert max-w-none">
          ...
          <section id="data-collection" className="scroll-mt-28 space-y-4">
            ...
            <p>
              <strong>We collect nothing.</strong> Focus is built as a zero-telemetry personal app and offline-first system. All details you enter into the application, including your mood logs, reflective journal notes, daily streaks, habits, explore hubs, and custom milestones, remain entirely local.
            </p>
            <p>
              There are no registration requirements to use this zero-telemetry personal app, no mandatory email logins within the container, and no remote servers designed to track user IDs.
            </p>
          </section>
          ...
          <section id="data-storage" className="scroll-mt-28 space-y-4">
            ...
            <p>
              Any data generated during your focus sessions is saved on your physical device using a local sandboxed SQLite Room database, ensuring offline-first secure journaling. This storage is completely isolated from other applications running on your operating system and cannot be read by external packages.
            </p>
            <p>
              Since we do not run cloud backup nodes for your records, your offline-first secure journaling entries stay safe inside your device. If you uninstall Focus or physically lose your device, your local data cannot be restored by us. We recommend making manual backups if needed.
            </p>
          </section>
